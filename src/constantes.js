...
export const SERVICIOS = [
  {
    ...
    descripcion: "Sesión regular de seguimiento y actividades terapéuticas guiadas.",
    duracion: "45 min",
    duracionMinutos: 45,
    icono: Brain,
  },
  {
    ...
    descripcion: "Pruebas neuropsicológicas completas para diagnóstico inicial o revisión.",
    duracion: "90 min",
    duracionMinutos: 90,
    icono: ClipboardList,
  },
...
export const DIAS_SEMANA_LARGOS = ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"];
export const MESES = [
